...
$sq = "SELECT message,time FROM advisormessage WHERE regnumber='$user' ";
$data = $conn->query($sq);
if($data->num_rows > 0){
...
if($messageError ==""){
  ...
  $sql = "INSERT INTO clientmessage(regnumber, message) VALUES('$regnumber','$message')";
...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    <li style="text-align:center;font-family: 'Poppins', sans-serif"><a href="advisor.php?user=<?php echo $fetch["regnumberclient"];?>" ><?php echo $fetch["regnumberclient"];} ?></a></li><br>
  ...
  >
    <p  style="text-align:center;font-family: 'Poppins', sans-serif;color:white">Your client is Online</p>
  </div>
